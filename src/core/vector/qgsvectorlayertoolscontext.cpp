...
void QgsVectorLayerToolsContext::setExpressionContext( QgsExpressionContext *context )
{
  if ( context )
...
void QgsVectorLayerToolsContext::setAdditionalExpressionContextScope( QgsExpressionContextScope *scope )
{
  if ( scope )
...
QgsExpressionContextScope *QgsVectorLayerToolsContext::additionalExpressionContextScope()
{
