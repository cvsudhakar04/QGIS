...
bool QgsTrackedVectorLayerTools::addFeatureV2( QgsVectorLayer *layer, const QgsAttributeMap &defaultValues, const QgsGeometry &defaultGeometry, QgsFeature *feature, QWidget *parentWidget, bool showModal, bool hideParent, QgsVectorLayerToolsContext *context ) const
{
  ...
  if ( mBackend->addFeatureV2( layer, defaultValues, defaultGeometry, f, parentWidget, showModal, hideParent, context ) )
  {
